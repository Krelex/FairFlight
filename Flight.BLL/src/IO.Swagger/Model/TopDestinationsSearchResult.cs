...
namespace IO.Swagger.Model
{
    ...
    public partial class TopDestinationsSearchResult :  IEquatable<TopDestinationsSearchResult>, IValidatableObject
    {
        ...
        {
            return this.Equals(input as TopDestinationsSearchResult);
        }

        /// <summary>
        /// Returns true if TopDestinationsSearchResult instances are equal
        /// </summary>
        /// <param name="input">Instance of TopDestinationsSearchResult to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TopDestinationsSearchResult input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    ...
                    (this.Flights != null &&
                    this.Flights.Equals(input.Flights))
                ) && 
                (
                    this.Travelers == input.Travelers ||
                    (this.Travelers != null &&
                    this.Travelers.Equals(input.Travelers))
                );
        }
