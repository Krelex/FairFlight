...
namespace IO.Swagger.Model
{
    ...
    public partial class FlightSearchSegment :  IEquatable<FlightSearchSegment>, IValidatableObject
    {
        ...
        {
            return this.Equals(input as FlightSearchSegment);
        }

        /// <summary>
        /// Returns true if FlightSearchSegment instances are equal
        /// </summary>
        /// <param name="input">Instance of FlightSearchSegment to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(FlightSearchSegment input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.MarketingAirline == input.MarketingAirline ||
                    (this.MarketingAirline != null &&
                    this.MarketingAirline.Equals(input.MarketingAirline))
                ) && 
                (
                    this.OperatingAirline == input.OperatingAirline ||
                    (this.OperatingAirline != null &&
                    this.OperatingAirline.Equals(input.OperatingAirline))
                ) && 
                (
                ...
                (
                    ...
                    (this.Aircraft != null &&
                    this.Aircraft.Equals(input.Aircraft))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.MarketingAirline != null)
                    hashCode = hashCode * 59 + this.MarketingAirline.GetHashCode();
                if (this.OperatingAirline != null)
                    hashCode = hashCode * 59 + this.OperatingAirline.GetHashCode();
                if (this.FlightNumber != null)
                    hashCode = hashCode * 59 + this.FlightNumber.GetHashCode();
                if (this.Aircraft != null)
                    hashCode = hashCode * 59 + this.Aircraft.GetHashCode();
