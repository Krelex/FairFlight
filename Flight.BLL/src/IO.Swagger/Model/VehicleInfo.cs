...
namespace IO.Swagger.Model
{
    ...
    public partial class VehicleInfo :  IEquatable<VehicleInfo>, IValidatableObject
    {
        ...
        {
            return this.Equals(input as VehicleInfo);
        }

        /// <summary>
        /// Returns true if VehicleInfo instances are equal
        /// </summary>
        /// <param name="input">Instance of VehicleInfo to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(VehicleInfo input)
        {
            if (input == null)
                return false;
            ...
            return 
                (
                    this.AcrissCode == input.AcrissCode ||
                    (this.AcrissCode != null &&
                    this.AcrissCode.Equals(input.AcrissCode))
                ) && 
                (
                ...
                (
                    ...
                    this.Transmission.Equals(input.Transmission))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.AcrissCode != null)
                    hashCode = hashCode * 59 + this.AcrissCode.GetHashCode();
                if (this.Category != null)
                    hashCode = hashCode * 59 + this.Category.GetHashCode();
                if (this.Type != null)
                    hashCode = hashCode * 59 + this.Type.GetHashCode();
                if (this.Transmission != null)
                    hashCode = hashCode * 59 + this.Transmission.GetHashCode();
