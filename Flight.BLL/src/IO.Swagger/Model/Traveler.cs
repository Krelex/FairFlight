...
namespace IO.Swagger.Model
{
    ...
    public partial class Traveler :  IEquatable<Traveler>, IValidatableObject
    {
        ...
        {
            return this.Equals(input as Traveler);
        }

        /// <summary>
        /// Returns true if Traveler instances are equal
        /// </summary>
        /// <param name="input">Instance of Traveler to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(Traveler input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.TravelerType == input.TravelerType ||
                    (this.TravelerType != null &&
                    this.TravelerType.Equals(input.TravelerType))
                ) && 
                (
                ...
                (
                    this.FrequentTravelerCards == input.FrequentTravelerCards ||
                    this.FrequentTravelerCards != null &&
                    this.FrequentTravelerCards.SequenceEqual(input.FrequentTravelerCards)
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.TravelerType != null)
                    hashCode = hashCode * 59 + this.TravelerType.GetHashCode();
                if (this.Infant != null)
                ...
                if (this.FrequentTravelerCards != null)
                    hashCode = hashCode * 59 + this.FrequentTravelerCards.GetHashCode();
                return hashCode;
            }
        }
