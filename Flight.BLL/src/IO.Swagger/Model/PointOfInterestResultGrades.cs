...
namespace IO.Swagger.Model
{
    ...
    public partial class PointOfInterestResultGrades :  IEquatable<PointOfInterestResultGrades>, IValidatableObject
    {
        ...
        {
            return this.Equals(input as PointOfInterestResultGrades);
        }

        /// <summary>
        /// Returns true if PointOfInterestResultGrades instances are equal
        /// </summary>
        /// <param name="input">Instance of PointOfInterestResultGrades to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PointOfInterestResultGrades input)
        {
            if (input == null)
                return false;
            ...
            return 
                (
                    this.YapqGrade == input.YapqGrade ||
                    (this.YapqGrade != null &&
                    this.YapqGrade.Equals(input.YapqGrade))
                ) && 
                (
                    this.CityGrade == input.CityGrade ||
                    (this.CityGrade != null &&
                    this.CityGrade.Equals(input.CityGrade))
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.YapqGrade != null)
                    hashCode = hashCode * 59 + this.YapqGrade.GetHashCode();
                if (this.CityGrade != null)
                    hashCode = hashCode * 59 + this.CityGrade.GetHashCode();
                return hashCode;
            }
        }
