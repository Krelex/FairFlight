...
namespace IO.Swagger.Model
{
    ...
    public partial class Amount :  IEquatable<Amount>, IValidatableObject
    {
        ...
        /// <param name="_Amount">Total amount in the given currency, formatted appropriately. For example&amp;colon; 194.99 (required).</param>
        public Amount(string Currency = default(string), string _Amount = default(string))
        {
            ...
            // to ensure "_Amount" is required (not null)
            if (_Amount == null)
            {
                throw new InvalidDataException("_Amount is a required property for Amount and cannot be null");
            }
            else
            {
        ...
        /// </summary>
        /// <value>Total amount in the given currency, formatted appropriately. For example&amp;colon; 194.99</value>
