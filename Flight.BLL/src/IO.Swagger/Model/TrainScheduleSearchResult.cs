...
namespace IO.Swagger.Model
{
    ...
    public partial class TrainScheduleSearchResult :  IEquatable<TrainScheduleSearchResult>, IValidatableObject
    {
        ...
        {
            return this.Equals(input as TrainScheduleSearchResult);
        }

        /// <summary>
        /// Returns true if TrainScheduleSearchResult instances are equal
        /// </summary>
        /// <param name="input">Instance of TrainScheduleSearchResult to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrainScheduleSearchResult input)
        {
            if (input == null)
                return false;
            ...
            return 
                (
                    this.OriginStationId == input.OriginStationId ||
                    (this.OriginStationId != null &&
                    this.OriginStationId.Equals(input.OriginStationId))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.OriginStationId != null)
                    hashCode = hashCode * 59 + this.OriginStationId.GetHashCode();
                if (this.Date != null)
