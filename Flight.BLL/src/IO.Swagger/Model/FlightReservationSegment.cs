...
namespace IO.Swagger.Model
{
    ...
    public partial class FlightReservationSegment :  IEquatable<FlightReservationSegment>, IValidatableObject
    {
        ...
        {
            return this.Equals(input as FlightReservationSegment);
        }

        /// <summary>
        /// Returns true if FlightReservationSegment instances are equal
        /// </summary>
        /// <param name="input">Instance of FlightReservationSegment to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(FlightReservationSegment input)
        {
            if (input == null)
                return false;
