...
namespace IO.Swagger.Model
{
    ...
    public partial class ExtremeSearchResponse :  IEquatable<ExtremeSearchResponse>, IValidatableObject
    {
        ...
        {
            return this.Equals(input as ExtremeSearchResponse);
        }

        /// <summary>
        /// Returns true if ExtremeSearchResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of ExtremeSearchResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ExtremeSearchResponse input)
        {
            if (input == null)
                return false;
