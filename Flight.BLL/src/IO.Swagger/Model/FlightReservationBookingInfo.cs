...
namespace IO.Swagger.Model
{
    ...
    public partial class FlightReservationBookingInfo :  IEquatable<FlightReservationBookingInfo>, IValidatableObject
    {
        ...
        {
            return this.Equals(input as FlightReservationBookingInfo);
        }

        /// <summary>
        /// Returns true if FlightReservationBookingInfo instances are equal
        /// </summary>
        /// <param name="input">Instance of FlightReservationBookingInfo to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(FlightReservationBookingInfo input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.AirlineRecordLocator == input.AirlineRecordLocator ||
                    (this.AirlineRecordLocator != null &&
                    this.AirlineRecordLocator.Equals(input.AirlineRecordLocator))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.AirlineRecordLocator != null)
                    hashCode = hashCode * 59 + this.AirlineRecordLocator.GetHashCode();
                if (this.Status != null)
