...
namespace IO.Swagger.Model
{
    ...
    public partial class HotelPropertyResponse :  IEquatable<HotelPropertyResponse>, IValidatableObject
    {
        ...
        {
            return this.Equals(input as HotelPropertyResponse);
        }

        /// <summary>
        /// Returns true if HotelPropertyResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of HotelPropertyResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(HotelPropertyResponse input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.MinDailyRate == input.MinDailyRate ||
                    (this.MinDailyRate != null &&
                    this.MinDailyRate.Equals(input.MinDailyRate))
                ) && 
                (
                ...
                (
                    ...
                    this.Awards != null &&
                    this.Awards.SequenceEqual(input.Awards)
                ) && 
                (
                ...
                (
                    this.MoreRoomsAtThisHotel == input.MoreRoomsAtThisHotel ||
                    (this.MoreRoomsAtThisHotel != null &&
                    this.MoreRoomsAtThisHotel.Equals(input.MoreRoomsAtThisHotel))
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.MinDailyRate != null)
                    hashCode = hashCode * 59 + this.MinDailyRate.GetHashCode();
                ...
                if (this.MoreRoomsAtThisHotel != null)
                    hashCode = hashCode * 59 + this.MoreRoomsAtThisHotel.GetHashCode();
                return hashCode;
            }
        }
