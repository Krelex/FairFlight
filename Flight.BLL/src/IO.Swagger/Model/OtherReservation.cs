...
namespace IO.Swagger.Model
{
    ...
    public partial class OtherReservation :  IEquatable<OtherReservation>, IValidatableObject
    {
        ...
        {
            return this.Equals(input as OtherReservation);
        }

        /// <summary>
        /// Returns true if OtherReservation instances are equal
        /// </summary>
        /// <param name="input">Instance of OtherReservation to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OtherReservation input)
        {
            if (input == null)
                return false;
