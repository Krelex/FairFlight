...
namespace IO.Swagger.Model
{
    ...
    public partial class ExtremeSearchResult :  IEquatable<ExtremeSearchResult>, IValidatableObject
    {
        ...
        {
            return this.Equals(input as ExtremeSearchResult);
        }

        /// <summary>
        /// Returns true if ExtremeSearchResult instances are equal
        /// </summary>
        /// <param name="input">Instance of ExtremeSearchResult to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ExtremeSearchResult input)
        {
            if (input == null)
                return false;
