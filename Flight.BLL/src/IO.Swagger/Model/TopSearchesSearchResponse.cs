...
namespace IO.Swagger.Model
{
    ...
    public partial class TopSearchesSearchResponse :  IEquatable<TopSearchesSearchResponse>, IValidatableObject
    {
        ...
        {
            return this.Equals(input as TopSearchesSearchResponse);
        }

        /// <summary>
        /// Returns true if TopSearchesSearchResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of TopSearchesSearchResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TopSearchesSearchResponse input)
        {
            if (input == null)
                return false;
