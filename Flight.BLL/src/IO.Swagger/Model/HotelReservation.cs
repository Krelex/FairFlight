...
namespace IO.Swagger.Model
{
    ...
    public partial class HotelReservation :  IEquatable<HotelReservation>, IValidatableObject
    {
        ...
        {
            return this.Equals(input as HotelReservation);
        }

        /// <summary>
        /// Returns true if HotelReservation instances are equal
        /// </summary>
        /// <param name="input">Instance of HotelReservation to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(HotelReservation input)
        {
            if (input == null)
                return false;
