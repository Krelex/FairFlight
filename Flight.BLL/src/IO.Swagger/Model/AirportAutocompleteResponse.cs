...
namespace IO.Swagger.Model
{
    ...
    public partial class AirportAutocompleteResponse :  IEquatable<AirportAutocompleteResponse>, IValidatableObject
    {
        ...
        {
            return this.Equals(input as AirportAutocompleteResponse);
        }

        /// <summary>
        /// Returns true if AirportAutocompleteResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of AirportAutocompleteResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AirportAutocompleteResponse input)
        {
            if (input == null)
                return false;
