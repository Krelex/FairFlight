...
namespace IO.Swagger.Model
{
    ...
    public partial class FlightTrafficSearchResult :  IEquatable<FlightTrafficSearchResult>, IValidatableObject
    {
        ...
        {
            return this.Equals(input as FlightTrafficSearchResult);
        }

        /// <summary>
        /// Returns true if FlightTrafficSearchResult instances are equal
        /// </summary>
        /// <param name="input">Instance of FlightTrafficSearchResult to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(FlightTrafficSearchResult input)
        {
            if (input == null)
                return false;
