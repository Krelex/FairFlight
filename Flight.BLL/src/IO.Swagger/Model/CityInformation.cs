...
namespace IO.Swagger.Model
{
    ...
    public partial class CityInformation :  IEquatable<CityInformation>, IValidatableObject
    {
        ...
        {
            return this.Equals(input as CityInformation);
        }

        /// <summary>
        /// Returns true if CityInformation instances are equal
        /// </summary>
        /// <param name="input">Instance of CityInformation to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CityInformation input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.GeonamesID == input.GeonamesID ||
                    (this.GeonamesID != null &&
                    this.GeonamesID.Equals(input.GeonamesID))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.GeonamesID != null)
                    hashCode = hashCode * 59 + this.GeonamesID.GetHashCode();
                if (this.Name != null)
