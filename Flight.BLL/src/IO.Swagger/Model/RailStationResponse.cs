...
namespace IO.Swagger.Model
{
    ...
    public partial class RailStationResponse :  IEquatable<RailStationResponse>, IValidatableObject
    {
        ...
        {
            return this.Equals(input as RailStationResponse);
        }

        /// <summary>
        /// Returns true if RailStationResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of RailStationResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RailStationResponse input)
        {
            if (input == null)
                return false;
