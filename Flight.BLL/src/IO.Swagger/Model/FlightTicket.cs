...
namespace IO.Swagger.Model
{
    ...
    public partial class FlightTicket :  IEquatable<FlightTicket>, IValidatableObject
    {
        ...
        {
            return this.Equals(input as FlightTicket);
        }

        /// <summary>
        /// Returns true if FlightTicket instances are equal
        /// </summary>
        /// <param name="input">Instance of FlightTicket to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(FlightTicket input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.FlightBounds == input.FlightBounds ||
                    this.FlightBounds != null &&
                    this.FlightBounds.SequenceEqual(input.FlightBounds)
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.FlightBounds != null)
                    hashCode = hashCode * 59 + this.FlightBounds.GetHashCode();
                return hashCode;
            }
        }
