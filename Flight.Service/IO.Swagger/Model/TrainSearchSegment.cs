...
namespace IO.Swagger.Model
{
    ...
    public partial class TrainSearchSegment :  IEquatable<TrainSearchSegment>, IValidatableObject
    {
        ...
        {
            return this.Equals(input as TrainSearchSegment);
        }

        /// <summary>
        /// Returns true if TrainSearchSegment instances are equal
        /// </summary>
        /// <param name="input">Instance of TrainSearchSegment to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrainSearchSegment input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.MarketingCompany == input.MarketingCompany ||
                    (this.MarketingCompany != null &&
                    this.MarketingCompany.Equals(input.MarketingCompany))
                ) && 
                (
                    this.OperatingCompany == input.OperatingCompany ||
                    (this.OperatingCompany != null &&
                    this.OperatingCompany.Equals(input.OperatingCompany))
                ) && 
                (
                ...
                (
                    this.TrainType == input.TrainType ||
                    (this.TrainType != null &&
                    this.TrainType.Equals(input.TrainType))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.MarketingCompany != null)
                    hashCode = hashCode * 59 + this.MarketingCompany.GetHashCode();
                if (this.OperatingCompany != null)
                    hashCode = hashCode * 59 + this.OperatingCompany.GetHashCode();
                if (this.TrainNumber != null)
                    hashCode = hashCode * 59 + this.TrainNumber.GetHashCode();
                if (this.TrainType != null)
                    hashCode = hashCode * 59 + this.TrainType.GetHashCode();
                if (this.Prices != null)
