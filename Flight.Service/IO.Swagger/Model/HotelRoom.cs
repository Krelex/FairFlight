...
namespace IO.Swagger.Model
{
    ...
    public partial class HotelRoom :  IEquatable<HotelRoom>, IValidatableObject
    {
        ...
        {
            return this.Equals(input as HotelRoom);
        }

        /// <summary>
        /// Returns true if HotelRoom instances are equal
        /// </summary>
        /// <param name="input">Instance of HotelRoom to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(HotelRoom input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.RatePlanCode == input.RatePlanCode ||
                    (this.RatePlanCode != null &&
                    this.RatePlanCode.Equals(input.RatePlanCode))
                ) && 
                (
                ...
                (
                    this.RoomTypeInfo == input.RoomTypeInfo ||
                    (this.RoomTypeInfo != null &&
                    this.RoomTypeInfo.Equals(input.RoomTypeInfo))
                ) && 
                (
                    this.RateTypeCode == input.RateTypeCode ||
                    (this.RateTypeCode != null &&
                    this.RateTypeCode.Equals(input.RateTypeCode))
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.RatePlanCode != null)
                    hashCode = hashCode * 59 + this.RatePlanCode.GetHashCode();
                ...
                if (this.RoomTypeInfo != null)
                    hashCode = hashCode * 59 + this.RoomTypeInfo.GetHashCode();
                if (this.RateTypeCode != null)
                    hashCode = hashCode * 59 + this.RateTypeCode.GetHashCode();
                return hashCode;
            }
        }
