...
namespace IO.Swagger.Model
{
    ...
    public partial class RestrictedRate :  IEquatable<RestrictedRate>, IValidatableObject
    {
        ...
        {
            return this.Equals(input as RestrictedRate);
        }

        /// <summary>
        /// Returns true if RestrictedRate instances are equal
        /// </summary>
        /// <param name="input">Instance of RestrictedRate to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RestrictedRate input)
        {
            if (input == null)
                return false;
            ...
            return 
                (
                    this.RateCode == input.RateCode ||
                    (this.RateCode != null &&
                    this.RateCode.Equals(input.RateCode))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.RateCode != null)
                    hashCode = hashCode * 59 + this.RateCode.GetHashCode();
