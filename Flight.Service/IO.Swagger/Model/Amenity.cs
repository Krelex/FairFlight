...
namespace IO.Swagger.Model
{
    ...
    public partial class Amenity :  IEquatable<Amenity>, IValidatableObject
    {
        ...
        {
            return this.Equals(input as Amenity);
        }

        /// <summary>
        /// Returns true if Amenity instances are equal
        /// </summary>
        /// <param name="input">Instance of Amenity to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(Amenity input)
        {
            if (input == null)
                return false;
            ...
            return 
                (
                    this._Amenity == input._Amenity ||
                    (this._Amenity != null &&
                    this._Amenity.Equals(input._Amenity))
                ) && 
                (
                    this.OtaCode == input.OtaCode ||
                    (this.OtaCode != null &&
                    this.OtaCode.Equals(input.OtaCode))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this._Amenity != null)
                    hashCode = hashCode * 59 + this._Amenity.GetHashCode();
                if (this.OtaCode != null)
                    hashCode = hashCode * 59 + this.OtaCode.GetHashCode();
