...
namespace IO.Swagger.Model
{
    ...
    public partial class FlightSearchItinerary :  IEquatable<FlightSearchItinerary>, IValidatableObject
    {
        ...
        {
            return this.Equals(input as FlightSearchItinerary);
        }

        /// <summary>
        /// Returns true if FlightSearchItinerary instances are equal
        /// </summary>
        /// <param name="input">Instance of FlightSearchItinerary to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(FlightSearchItinerary input)
        {
            if (input == null)
                return false;
