...
namespace IO.Swagger.Model
{
    ...
    public partial class AirportInformation :  IEquatable<AirportInformation>, IValidatableObject
    {
        ...
        {
            return this.Equals(input as AirportInformation);
        }

        /// <summary>
        /// Returns true if AirportInformation instances are equal
        /// </summary>
        /// <param name="input">Instance of AirportInformation to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AirportInformation input)
        {
            if (input == null)
                return false;
