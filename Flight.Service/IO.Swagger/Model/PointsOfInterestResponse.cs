...
namespace IO.Swagger.Model
{
    ...
    public partial class PointsOfInterestResponse :  IEquatable<PointsOfInterestResponse>, IValidatableObject
    {
        ...
        {
            return this.Equals(input as PointsOfInterestResponse);
        }

        /// <summary>
        /// Returns true if PointsOfInterestResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of PointsOfInterestResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PointsOfInterestResponse input)
        {
            if (input == null)
                return false;
            ...
            return 
                (
                    this.CurrentCity == input.CurrentCity ||
                    (this.CurrentCity != null &&
                    this.CurrentCity.Equals(input.CurrentCity))
                ) && 
                (
                    this.PointsOfInterest == input.PointsOfInterest ||
                    this.PointsOfInterest != null &&
                    this.PointsOfInterest.SequenceEqual(input.PointsOfInterest)
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.CurrentCity != null)
                    hashCode = hashCode * 59 + this.CurrentCity.GetHashCode();
                if (this.PointsOfInterest != null)
                    hashCode = hashCode * 59 + this.PointsOfInterest.GetHashCode();
                return hashCode;
            }
        }
