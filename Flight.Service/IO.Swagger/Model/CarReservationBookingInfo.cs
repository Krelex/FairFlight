...
namespace IO.Swagger.Model
{
    ...
    public partial class CarReservationBookingInfo :  IEquatable<CarReservationBookingInfo>, IValidatableObject
    {
        ...
        {
            return this.Equals(input as CarReservationBookingInfo);
        }

        /// <summary>
        /// Returns true if CarReservationBookingInfo instances are equal
        /// </summary>
        /// <param name="input">Instance of CarReservationBookingInfo to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CarReservationBookingInfo input)
        {
            if (input == null)
                return false;
