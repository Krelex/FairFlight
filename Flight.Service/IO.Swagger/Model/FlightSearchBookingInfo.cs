...
namespace IO.Swagger.Model
{
    ...
    public partial class FlightSearchBookingInfo :  IEquatable<FlightSearchBookingInfo>, IValidatableObject
    {
        ...
        {
            return this.Equals(input as FlightSearchBookingInfo);
        }

        /// <summary>
        /// Returns true if FlightSearchBookingInfo instances are equal
        /// </summary>
        /// <param name="input">Instance of FlightSearchBookingInfo to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(FlightSearchBookingInfo input)
        {
            if (input == null)
                return false;
            ...
            return 
                (
                    this.TravelClass == input.TravelClass ||
                    (this.TravelClass != null &&
                    this.TravelClass.Equals(input.TravelClass))
                ) && 
                (
                    this.CabinCode == input.CabinCode ||
                    (this.CabinCode != null &&
                    this.CabinCode.Equals(input.CabinCode))
                ) && 
                (
                ...
                (
                    this.SeatsRemaining == input.SeatsRemaining ||
                    (this.SeatsRemaining != null &&
                    this.SeatsRemaining.Equals(input.SeatsRemaining))
                ) && 
                (
                    this.FareFamily == input.FareFamily ||
                    (this.FareFamily != null &&
                    this.FareFamily.Equals(input.FareFamily))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.TravelClass != null)
                    hashCode = hashCode * 59 + this.TravelClass.GetHashCode();
                if (this.CabinCode != null)
                    hashCode = hashCode * 59 + this.CabinCode.GetHashCode();
                if (this.BookingCode != null)
                    hashCode = hashCode * 59 + this.BookingCode.GetHashCode();
                if (this.SeatsRemaining != null)
                    hashCode = hashCode * 59 + this.SeatsRemaining.GetHashCode();
                if (this.FareFamily != null)
                    hashCode = hashCode * 59 + this.FareFamily.GetHashCode();
