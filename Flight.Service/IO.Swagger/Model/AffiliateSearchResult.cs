...
namespace IO.Swagger.Model
{
    ...
    public partial class AffiliateSearchResult :  IEquatable<AffiliateSearchResult>, IValidatableObject
    {
        ...
        {
            return this.Equals(input as AffiliateSearchResult);
        }

        /// <summary>
        /// Returns true if AffiliateSearchResult instances are equal
        /// </summary>
        /// <param name="input">Instance of AffiliateSearchResult to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AffiliateSearchResult input)
        {
            if (input == null)
                return false;
