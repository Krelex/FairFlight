...
namespace IO.Swagger.Model
{
    ...
    public partial class NearestAirport :  IEquatable<NearestAirport>, IValidatableObject
    {
        ...
        {
            return this.Equals(input as NearestAirport);
        }

        /// <summary>
        /// Returns true if NearestAirport instances are equal
        /// </summary>
        /// <param name="input">Instance of NearestAirport to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(NearestAirport input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.AirportName == input.AirportName ||
                    (this.AirportName != null &&
                    this.AirportName.Equals(input.AirportName))
                ) && 
                (
                ...
                (
                    this.AircraftMovements == input.AircraftMovements ||
                    (this.AircraftMovements != null &&
                    this.AircraftMovements.Equals(input.AircraftMovements))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.AirportName != null)
                    hashCode = hashCode * 59 + this.AirportName.GetHashCode();
                if (this.City != null)
                ...
                if (this.AircraftMovements != null)
                    hashCode = hashCode * 59 + this.AircraftMovements.GetHashCode();
