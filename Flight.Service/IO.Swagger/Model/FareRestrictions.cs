...
namespace IO.Swagger.Model
{
    ...
    public partial class FareRestrictions :  IEquatable<FareRestrictions>, IValidatableObject
    {
        ...
        {
            return this.Equals(input as FareRestrictions);
        }

        /// <summary>
        /// Returns true if FareRestrictions instances are equal
        /// </summary>
        /// <param name="input">Instance of FareRestrictions to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(FareRestrictions input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.ChangePenalties == input.ChangePenalties ||
                    (this.ChangePenalties != null &&
                    this.ChangePenalties.Equals(input.ChangePenalties))
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.ChangePenalties != null)
                    hashCode = hashCode * 59 + this.ChangePenalties.GetHashCode();
                return hashCode;
            }
        }
